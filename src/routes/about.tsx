...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "О компании — OzTop Media" },
      { name: "description", content: "OzTop Media — платформа для накрутки в 40+ соцсетях. 8 лет на рынке, 11.8 млн выполненных заказов, 115 тыс. клиентов." },
      { property: "og:title", content: "О компании — OzTop Media" },
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14">
      <div className="max-w-3xl">
        <h1 className="text-3xl md:text-5xl font-extrabold leading-tight">О компании OzTop Media</h1>
