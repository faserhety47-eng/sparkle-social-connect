...
export const DEFAULT_FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Алгоритмы OzTop Media контролируют скорость и качество накрутки, чтобы не вызывать подозрений со стороны соцсетей. Мы стараемся делать накрутку предельно безопасной.",
  },
  {
    q: "Нужна ли регистрация для заказа?",
    a: "Нет. Регистрация не требуется — вы можете оформить заказ и попробовать бесплатные пакеты сразу с главной страницы.",
  },
  {
